...
void SYS_Initialize ( void *data )
{
    ...
    TRISAbits.TRISA4 = 0; // Set RA4 to output (red LED)
    LATAbits.LATA4 = 0;
    
    TRISBbits.TRISB9 = 0; //modepin set high for phase/enable on hbridge
    LATBbits.LATB9 = 1; // set phase enable
    // need 2 pins for phase
    TRISBbits.TRISB7 = 0;//RB7 for phase 1
    TRISBbits.TRISB13 = 0;//RB13 for phase 2
    ...
    //Initialize OC2 on B8 for enable on motor 1
    ...
    //Initialize OC1 on A0 for enable on motor 1
    ...
    LATBbits.LATB7 = 1; //set phase forward for bridge 1
    LATBbits.LATB13 = 0; //set phase forward for bridge 2
