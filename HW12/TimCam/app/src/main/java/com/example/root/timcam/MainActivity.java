package com.example.root.timcam;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    public int bar2val = 161;
    public int bar3val = 109;
    public int bar4val = 102;
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            if ((com[1]>= 280) && (com[1]<= 360)){ //forward particle is centered

                //full speed ahead!
                command.setText("Full Speed Ahead!");
            }

            if (com[1]> 360){ //forward particle is right
            ...
            if (com[1]< 280){ //forward particle is left
                if (com[3] <280) {//back particle is left
